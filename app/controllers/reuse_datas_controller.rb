class ReuseDatasController < ApplicationController
  ...
  def update_values
      ...
      if is_a_number?value
         ...
         if field == 'contained'
            @manufacturing_data.contained_data = value
         end
         if field == 'anticipated'
            @manufacturing_data.anticipated_data = value
         end   
         if field == 'contained_repair'
            @manufacturing_data.repair_contained_data = value
         end   
         if field == 'anticipated_repair'
            @manufacturing_data.repair_anticipated_data = value
         end   
